...
T{1} = [230 226 175; 167 163 126; 239 236 202; 4 99 128; 0 47 47]/255;
Match{1} = [3 1 4 2 4];
T{2} = [70 137 102; 255 240 165; 255 176 59; 182 73 38; 142 40 0]/255;
Match{2} = [2 5 1 4 1];
T{3} = [248 251 251; 18 138 156; 98 175 74; 180 32 212; 20 74 5]/255;
Match{3} = [1 2 3 4 5];
T{4} = [115 96 61; 191 138 73; 242 202 128; 94 90 89; 13 13 13]/255;
Match{4} = [3 2 5 1 5];
T{5} = [185 18 27; 76 27 27; 246 228 151; 252 250 225; 189 141 70]/255;
Match{5} = [4 2 1 5 1];
T{6} = [249 250 250; 6 95 184; 164 208 226; 75 148 179; 236 127 18]/255;
Match{6} = [1 2 3 4 5];
T{7} = [249 250 250; 6 95 184; 150 208 44; 75 148 179; 236 127 18]/255;
Match{7} = [1 2 3 4 5];
